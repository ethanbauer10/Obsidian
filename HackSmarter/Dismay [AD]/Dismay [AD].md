...
So the idea here is to set a listener on my c2 then generate an agent, i can then host it using a python web server but by crafting the malicious DLL using a commdn
