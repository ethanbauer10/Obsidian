...
MSSQL       10.129.232.128  1433   DC01             [-] DC01\Administrator:0fwz7Q4mSpurIt99 (Login failed for user 'Administrator'. Please try again with or without '--local-auth')
MSSQL       10.129.232.128  1433   DC01             [-] DC01\Guest:0fwz7Q4mSpurIt99 (Login failed for user 'Guest'. Please try again with or without '--local-auth')
MSSQL       10.129.232.128  1433   DC01             [-] DC01\krbtgt:0fwz7Q4mSpurIt99 (Login failed for user 'krbtgt'. Please try again with or without '--local-auth')
MSSQL       10.129.232.128  1433   DC01             [-] DC01\DC01$:0fwz7Q4mSpurIt99 (Login failed for user 'DC01$'. Please try again with or without '--local-auth')
MSSQL       10.129.232.128  1433   DC01             [-] DC01\michael:0fwz7Q4mSpurIt99 (Login failed for user 'michael'. Please try again with or without '--local-auth')
MSSQL       10.129.232.128  1433   DC01             [-] DC01\ryan:0fwz7Q4mSpurIt99 (Login failed for user 'ryan'. Please try again with or without '--local-auth')
...
MSSQL       10.129.232.128  1433   DC01             [-] DC01\sql_svc:0fwz7Q4mSpurIt99 (Login failed for user 'sql_svc'. Please try again with or without '--local-auth')
MSSQL       10.129.232.128  1433   DC01             [-] DC01\rose:0fwz7Q4mSpurIt99 (Login failed for user 'rose'. Please try again with or without '--local-auth')
MSSQL       10.129.232.128  1433   DC01             [-] DC01\ca_svc:0fwz7Q4mSpurIt99 (Login failed for user 'ca_svc'. Please try again with or without '--local-auth')
...
MSSQL       10.129.232.128  1433   DC01             [-] DC01\Administrator:86LxLBMgEWaKUnBG (Login failed for user 'Administrator'. Please try again with or without '--local-auth')
MSSQL       10.129.232.128  1433   DC01             [-] DC01\Guest:86LxLBMgEWaKUnBG (Login failed for user 'Guest'. Please try again with or without '--local-auth')
MSSQL       10.129.232.128  1433   DC01             [-] DC01\krbtgt:86LxLBMgEWaKUnBG (Login failed for user 'krbtgt'. Please try again with or without '--local-auth')
MSSQL       10.129.232.128  1433   DC01             [-] DC01\DC01$:86LxLBMgEWaKUnBG (Login failed for user 'DC01$'. Please try again with or without '--local-auth')
MSSQL       10.129.232.128  1433   DC01             [-] DC01\michael:86LxLBMgEWaKUnBG (Login failed for user 'michael'. Please try again with or without '--local-auth')
MSSQL       10.129.232.128  1433   DC01             [-] DC01\ryan:86LxLBMgEWaKUnBG (Login failed for user 'ryan'. Please try again with or without '--local-auth')
...
MSSQL       10.129.232.128  1433   DC01             [-] DC01\sql_svc:86LxLBMgEWaKUnBG (Login failed for user 'sql_svc'. Please try again with or without '--local-auth')
MSSQL       10.129.232.128  1433   DC01             [-] DC01\rose:86LxLBMgEWaKUnBG (Login failed for user 'rose'. Please try again with or without '--local-auth')
MSSQL       10.129.232.128  1433   DC01             [-] DC01\ca_svc:86LxLBMgEWaKUnBG (Login failed for user 'ca_svc'. Please try again with or without '--local-auth')
...
MSSQL       10.129.232.128  1433   DC01             [-] DC01\Administrator:Md9Wlq1E5bZnVDVo (Login failed for user 'Administrator'. Please try again with or without '--local-auth')
MSSQL       10.129.232.128  1433   DC01             [-] DC01\Guest:Md9Wlq1E5bZnVDVo (Login failed for user 'Guest'. Please try again with or without '--local-auth')
MSSQL       10.129.232.128  1433   DC01             [-] DC01\krbtgt:Md9Wlq1E5bZnVDVo (Login failed for user 'krbtgt'. Please try again with or without '--local-auth')
MSSQL       10.129.232.128  1433   DC01             [-] DC01\DC01$:Md9Wlq1E5bZnVDVo (Login failed for user 'DC01$'. Please try again with or without '--local-auth')
MSSQL       10.129.232.128  1433   DC01             [-] DC01\michael:Md9Wlq1E5bZnVDVo (Login failed for user 'michael'. Please try again with or without '--local-auth')
MSSQL       10.129.232.128  1433   DC01             [-] DC01\ryan:Md9Wlq1E5bZnVDVo (Login failed for user 'ryan'. Please try again with or without '--local-auth')
...
MSSQL       10.129.232.128  1433   DC01             [-] DC01\sql_svc:Md9Wlq1E5bZnVDVo (Login failed for user 'sql_svc'. Please try again with or without '--local-auth')
MSSQL       10.129.232.128  1433   DC01             [-] DC01\rose:Md9Wlq1E5bZnVDVo (Login failed for user 'rose'. Please try again with or without '--local-auth')
MSSQL       10.129.232.128  1433   DC01             [-] DC01\ca_svc:Md9Wlq1E5bZnVDVo (Login failed for user 'ca_svc'. Please try again with or without '--local-auth')
...
MSSQL       10.129.232.128  1433   DC01             [-] DC01\Administrator:MSSQLP@ssw0rd! (Login failed for user 'Administrator'. Please try again with or without '--local-auth')
MSSQL       10.129.232.128  1433   DC01             [-] DC01\Guest:MSSQLP@ssw0rd! (Login failed for user 'Guest'. Please try again with or without '--local-auth')
MSSQL       10.129.232.128  1433   DC01             [-] DC01\krbtgt:MSSQLP@ssw0rd! (Login failed for user 'krbtgt'. Please try again with or without '--local-auth')
MSSQL       10.129.232.128  1433   DC01             [-] DC01\DC01$:MSSQLP@ssw0rd! (Login failed for user 'DC01$'. Please try again with or without '--local-auth')
MSSQL       10.129.232.128  1433   DC01             [-] DC01\michael:MSSQLP@ssw0rd! (Login failed for user 'michael'. Please try again with or without '--local-auth')
MSSQL       10.129.232.128  1433   DC01             [-] DC01\ryan:MSSQLP@ssw0rd! (Login failed for user 'ryan'. Please try again with or without '--local-auth')
...
MSSQL       10.129.232.128  1433   DC01             [-] DC01\sql_svc:MSSQLP@ssw0rd! (Login failed for user 'sql_svc'. Please try again with or without '--local-auth')
MSSQL       10.129.232.128  1433   DC01             [-] DC01\rose:MSSQLP@ssw0rd! (Login failed for user 'rose'. Please try again with or without '--local-auth')
MSSQL       10.129.232.128  1433   DC01             [-] DC01\ca_svc:MSSQLP@ssw0rd! (Login failed for user 'ca_svc'. Please try again with or without '--local-auth')
