...
Now ill put that into a pfx file, but in order to use it to authenticate i need to have access to `dc02` from my machine which means ill need to setup ligolo-ng f