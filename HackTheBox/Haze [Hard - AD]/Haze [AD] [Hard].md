...
Now if i login via evil-winrm i should have admin access.
...
*Evil-WinRM* PS C:\Users\paul.taylor\Documents> whoami /priv
...
*Evil-WinRM* PS C:\Users\paul.taylor\Documents>
```
Domain admin!
